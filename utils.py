...
def get_strategy(STRATEGY_NAME, dataset, net,diffuser, args_input, args_task):
	if STRATEGY_NAME == 'RandomSampling':
		return RandomSampling(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'LeastConfidence':
		return LeastConfidence(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'MarginSampling':
		return MarginSampling(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'EntropySampling':
		return EntropySampling(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'LeastConfidenceDropout':
		return LeastConfidenceDropout(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'MarginSamplingDropout':
		return MarginSamplingDropout(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'EntropySamplingDropout':
		return EntropySamplingDropout(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'KMeansSampling':
		return KMeansSampling(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'KMeansSamplingGPU':
		return KMeansSamplingGPU(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'KCenterGreedy':
		return KCenterGreedy(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'KCenterGreedyPCA':
		return KCenterGreedyPCA(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'BALDDropout':
		return BALDDropout(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'VarRatio':
		return VarRatio(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'MeanSTD':
		return MeanSTD(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'BadgeSampling':
		return BadgeSampling(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'LossPredictionLoss':		
		return LossPredictionLoss(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'AdversarialBIM':
		return AdversarialBIM(dataset, net, args_input, args_task,diffuser)
	elif STRATEGY_NAME == 'AdversarialDeepFool':
		return AdversarialDeepFool(dataset, net, args_input, args_task,diffuser)
	elif 'CEALSampling' in STRATEGY_NAME:
		return CEALSampling(dataset, net, args_input, args_task,diffuser)
