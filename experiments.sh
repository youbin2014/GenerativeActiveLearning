...
# GAL only
python demo.py --ALstrategy "MarginSampling" --GALstrategy "MarginSampling" --GAL_active 1 --quota "9000" --gpu 1 --dataset_name "CIFAR100" --GAL_data_folder "RS_epsilon_linear_0.5_1xgen" --template "a realistic photo of a {}" --epsilon 0 --emb_update_step 10 --emb_num_per_prompt 6 --samp_num_per_prompt 100 --samp_num_factor 0.5 --alpha_factor 5

## GAL only
#python demo.py --ALstrategy "MarginSampling" --GALstrategy "MarginSampling" --GAL_active 1 --quota "9000" --gpu 0 --dataset_name "TinyImageNet" --GAL_data_folder "RS_epsilon_linear_0.5_1xgen" --template "a realistic photo of a {}" --epsilon 0 --emb_update_step 10 --emb_num_per_prompt 6 --samp_num_per_prompt 100 --samp_num_factor 0.5 --alpha_factor 5