...
class CEALSampling(Strategy):
	def __init__(self, dataset, net, args_input, args_task, n_drop=10):
		...
		self.strategy_list = []
		self.strategy_list.append(RandomSampling(dataset, net, args_input, args_task,diffuser=None))
		self.strategy_list.append(LeastConfidence(dataset, net, args_input, args_task,diffuser=None))
		self.strategy_list.append(MarginSampling(dataset, net, args_input, args_task,diffuser=None))
		self.strategy_list.append(EntropySampling(dataset, net, args_input, args_task,diffuser=None))
		self.strategy_list.append(LeastConfidenceDropout(dataset, net, args_input, args_task,diffuser=None))
		self.strategy_list.append(MarginSamplingDropout(dataset, net, args_input, args_task,diffuser=None))
		self.strategy_list.append(EntropySamplingDropout(dataset, net, args_input, args_task,diffuser=None))
		self.strategy_list.append(KMeansSampling(dataset, net, args_input, args_task,diffuser=None))
		self.strategy_list.append(KCenterGreedy(dataset, net, args_input, args_task,diffuser=None))
		self.strategy_list.append(KCenterGreedyPCA(dataset, net, args_input, args_task,diffuser=None))
		self.strategy_list.append(BALDDropout(dataset, net, args_input, args_task,diffuser=None))
		self.strategy_list.append(BadgeSampling(dataset, net, args_input, args_task,diffuser=None))
		self.strategy_list.append(VarRatio(dataset, net, args_input, args_task,diffuser=None))
		self.strategy_list.append(MeanSTD(dataset, net, args_input, args_task,diffuser=None))
