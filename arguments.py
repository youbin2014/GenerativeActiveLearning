...
def get_args():
    ...
    # basic arguments
    parser.add_argument('--ALstrategy', '-a', default='MarginSampling', type=str,
                        help='name of active learning strategies')
    parser.add_argument('--GALstrategy', '-ga', default='MarginSampling', type=str,
                        help='name of active learning strategies')
    ...
    parser.add_argument('--net_name', '-n', default='resnet', type=str, help='network name')
    ...
    parser.add_argument('--template', '-temp', default='a photo of a {}', type=str,
                        help='template for T2I, labels will be put in {}')
    parser.add_argument('--epsilon', '-e', default=0.5, type=float,
                        help='range of linear epsilon schedule for text opt')
    ...
    parser.add_argument('--samp_num_factor', '-x', default=0.5, type=float,
                        help='total image sampling num/batch size in AL')
